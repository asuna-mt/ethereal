...
register_decoration(ethereal.rainforest, {
	place_on = "default:dirt_with_rainforest_litter",
	fill_ratio = 0.08,
	biomes = {"rainforest"},
...
register_decoration(1, {
	...
	biomes = {"desert_shore", "plains_shore", "sandstone_shore",
			"mesa_shore", "grove_shore", "deciduous_forest_shore"},
